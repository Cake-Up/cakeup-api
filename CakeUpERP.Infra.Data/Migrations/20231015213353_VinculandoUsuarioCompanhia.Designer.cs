...
namespace CakeUpERP.Infra.Data.Migrations
{
    ...
    [Migration("20231015213353_VinculandoUsuarioCompanhia")]
    partial class VinculandoUsuarioCompanhia
    {
            ...
            modelBuilder.Entity("CakeUpERP.Domain.Entities.CompanhiaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cnpj = "64547425000106",
                            DataCriacao = new DateTime(2023, 10, 15, 18, 33, 53, 203, DateTimeKind.Local).AddTicks(9874),

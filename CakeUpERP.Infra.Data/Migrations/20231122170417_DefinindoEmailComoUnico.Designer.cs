...
namespace CakeUpERP.Infra.Data.Migrations
{
    ...
    [Migration("20231122170417_DefinindoEmailComoUnico")]
    partial class DefinindoEmailComoUnico
    {
            ...
            modelBuilder.Entity("CakeUpERP.Domain.Entities.CompanhiaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cnpj = "64547425000106",
                            DataCriacao = new DateTime(2023, 11, 22, 14, 4, 16, 690, DateTimeKind.Local).AddTicks(966),
